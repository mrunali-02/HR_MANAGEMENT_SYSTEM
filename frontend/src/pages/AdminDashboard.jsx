                      ...
                      <td className="px-4 py-2 whitespace-nowrap text-right text-sm" onClick={(e) => e.stopPropagation()}>
                        <div className="flex items-center justify-end gap-2">
                          ...
                          <button
                            ...
                            className={`inline-flex items-center px-3 py-1.5 rounded-md text-white text-xs font-medium focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 ${la.status === 'rejected'
                              ? 'bg-red-700 hover:bg-red-800'
                              : 'bg-red-600 hover:bg-red-700'
                              }`}
                          >
                            {la.status === 'rejected' ? 'Confirm Reject' : 'Reject'}
                          </button>
                        </div>
                      </td>
                    </tr>
